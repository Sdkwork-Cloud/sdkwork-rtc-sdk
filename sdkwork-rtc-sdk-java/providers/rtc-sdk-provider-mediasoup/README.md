# Java mediasoup RTC Provider Package

Reserved Java provider package boundary for mediasoup RTC.
...
- manifest path: `providers/rtc-sdk-provider-mediasoup/pom.xml`
- readme path: `providers/rtc-sdk-provider-mediasoup/README.md`
- source path: `providers/rtc-sdk-provider-mediasoup/src/main/java/com/sdkwork/rtc/provider/mediasoup/RtcProviderMediasoupPackageContract.java`
