# Java Volcengine RTC Provider Package

Reserved Java provider package boundary for Volcengine RTC.
...
- manifest path: `providers/rtc-sdk-provider-volcengine/pom.xml`
- readme path: `providers/rtc-sdk-provider-volcengine/README.md`
- source path: `providers/rtc-sdk-provider-volcengine/src/main/java/com/sdkwork/rtc/provider/volcengine/RtcProviderVolcenginePackageContract.java`
